...
@dag(
    dag_id="instagram_meta_api_app4_dag",
    schedule=None,
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["instagram", "meta_api", "app4"],
    description="Collect Instagram data using Meta Graph API - App 4 - Sequential Execution"
)
def instagram_meta_api_app4_pipeline():
    
    # Lista de perfis para coletar dados - App 4
    perfis = [
        # Perfis do IFMA
        "neabicoelhonetoifma",
    ...
    for profile in perfis:
        ...
        fetch_task = fetch_data_meta_api.override(task_id=f"fetch_{profile}")( 
            ...
            max_posts=5000,
            app_id=4  # Usa credenciais do App 4
        )
...
# Instanciando o DAG
instagram_meta_api_app4_pipeline()
