...
@dag(
    dag_id="instagram_meta_api_app2_dag",
    schedule=None,
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=["instagram", "meta_api", "app2"],
    description="Collect Instagram data using Meta Graph API - App 2 - Sequential Execution"
)
def instagram_meta_api_app2_pipeline():
    
    # Lista de perfis para coletar dados - App 2
    perfis = [
        "bbcbrasil",
    ...
    for profile in perfis:
        ...
        fetch_task = fetch_data_meta_api.override(task_id=f"fetch_{profile}")( 
            ...
            max_posts=5000,
            app_id=2  # Usa credenciais do App 2
        )
...
# Instanciando o DAG
instagram_meta_api_app2_pipeline()
